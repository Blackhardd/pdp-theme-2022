            ...
            <div class="modal__inner" role="dialog" aria-modal="true">
                <div class="product product--gift-card">
                    ...
                    <div class="product__details">
                        ...
                        <div class="product__desc"><?=__( 'Чтобы уточннить наявность или задать интересующие вопросы, вы можете оставить свои контакты и мы вам перезвоним, чтоб уточнить все детали заказа.', 'pdp' ); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal__inner" role="dialog" aria-modal="true">
                <div class="product">
                    ...
                    <div class="product__details">
                        ...
                        <div class="product__desc"><?=__( 'Наполненить боксы косметикой вы можете в любом нашем салоне на свое усмотрение или с помощью администратора. Чтобы уточннить наявность или задать интересующие вопросы, вы можете оставить свои контакты и мы вам перезвоним, чтоб уточнить все детали заказа.', 'pdp' ); ?></div>
